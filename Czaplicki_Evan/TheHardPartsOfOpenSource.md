...
Another piece of that was: if a programming was going to be fun, I
...
lot of people who have worked in open source with larger projects will
relate to.
...
than it sounds.  Like if there is something you can think of in five
minutes, or an hour, or a day, probably someone has thought about that
and considered it.  And there might be implications that you do not
see from your perspective, but someone else in the community might
...
might have.  And I was like, "Oh, yes, very interesting.  I had not
thought about that."
...
So I was initially very upset about this, so the unfiltered, in my own
mind, version, was like [gestures as if holding a telephone up to his
ear and mouth]: "Oh, hello, is this the somebody store?  Yes, we would
like someone to take unsolicited advice on the Internet.  Oh, yeah, it
is really mean.  Yeah, it is going to be rough.  Yeah, no one is going
to say thank you.  No.  Yeah, it is unpaid.  It is unpaid.  You don't
have anybody?  I was told there would be _somebody_ who would do
this."

So this was me in my own life, walking around my room [gesturing with
hands in very frustrated upset manner].  And that is not a healthy
place to be.  That is not how I want to look to a community.  That is
not what I want a community I want to be a part of to be, either.  And
when I took some time and thought about it more, I realized there is
actually a pretty reasonable assumption going on here, which is: "Free
rice means you can take as much as you want."  The rice is free.  I
will take a lot of rice.

And so does that imply that free labor implies that you can use as
much as you want?  Well the labor is free.  But in fact this is not
how labor works.  If you do not pay for labor, you get less.  And so I
think that is sort of the root thing.  It is like: oh, well it should
be unlimited.  Anyone can help.

Now let us assume it is unlimited.  Everybody in the world actually
can help.  In practice, you actually have to work together.  These are
highly technical projects.  Are you able to work well together?  Are
your goals with the project aligned?  How much time does it take to
coordinate with that person to get stuff done?  So even if you can
work with anybody you want, there are still these limitations on who
is going to be really effective in doing the right stuff.
...
us what is the situation.  But who are you to say that?

And so this is another pattern I see a lot.  On whose authority?
...
"I say it with much admiration and respect to all the members of
community."
...
So Rich Hickey goes on to say:
    ...
    it gets harder to justify to justify to myself and my family that
    it's worth the energy and emotional burden.

Now I have talked to some people about this post, and to them
...
kind of a conservative estimate -- we are talking about like fifty
hours for this one that is just like dealing with someone's anger.
And could that have been spent dealing with someone new, or spending
time with some family members, or learning some hobby that could get
you out of work and get you a more healthy attitude.

So one thing I hear a lot when I talk about this stuff is: Well if it
makes you so mad, why don't you just not read it?  Why don't you just
... not read it?
...
user-definable infix operators?"  This came up with our recent
release.  And if we just focus on this question textually, someone
might say, "Yeah, there are cases where it makes code shorter and more
convenient."  And someone else might say, "No, because it can make
code harder to read, especially in a large team."
...
a large team.  And then onlookers will sort of say, oh, which ones
...
right.  All of these people have different priorities."  Some of them
may value flexibility a lot.  And some people might value simplicity a
lot.  And all of these people exist with different priorities.  So
this person is like, "Yeah, we should have this", really might value
flexibility.  And the person who says no, is saying, "Well, all of
these benefits you are telling me about flexibility, or how code can
be shorter and more convenient, that is not persuasive to me.  That is
not a 'good rational argument', because it is not important."

And likewise, "How does it work on a large team?"  Well this does not
matter.  It is not about that.  And all of these people exist on this
...
nothing is ever so emotionally difficult as these interactions.
...
Electronic Frontier Foundation.  That sort of ties these things
...
person, but at the messages going around".  And that is how we will
think about how the world works.

And so you see things like: words like life, soul, and purpose are
...
But a person is just a sort of special machine.  We can consider it as
...
we must now modify ourselves to exist in this new environment.  So it
is like, how can we take a person and simplify it down to a machine,
or a system we can understand well, and then once we are starting to
think of people that way, well we can improve machines.  We can add
things to them and the machines get more capabilities.  Maybe that is
how we move forward as people.

And life and purpose is like, we cannot go back to that.  It is too
different now.

So the connecting thread in "Whole Earth Catalog", besides Stuart
...
Internet.  And if you read these points as an ideal view of what the
...
you do.  And you can share that with whoever you want to.  Like there
is this place for self expression.
...
going to happen there.  And this publication and its creator, Stuart
Brand, have been really influential.

So one of the positive quotes was "When I was young, there was an
amazing publication called The Whole Earth Catalog, which was one of
the bibles of my generation."  So that was Steve Jobs.

There was a project that Stuart Brand created called The Ten Thousand
...
became very influential because of this how tools, and how a rejection
of hierarchy, we are somehow in this new place where we are going to
...
"I've listened my teacher explain for the fifteenth time how to reduce
a fraction.  I understand it.  "No, Ms. Smith, I didn't show my work.
I did it in my head...""
...
So when I take a step back on this intellectual pathway, the thing I
...
So it is just like, "Why don't you just ...?"  It is like we can just
...
well.  We need to find a way that is not structured in that way.  Like
your authority, as the author, is not legitimate on those grounds.
...
ways of looking at how we got to this level of conflict in open
source.  So I am calling this sort of the intellectual history of
...
So I want to start with a quote:
    ...
    day for business; even "holiday trips" put a strain on the nervous
    system."
...
Does this sounds familiar to anybody?  Finally:
...
left out was "due to the world-wide telegraph and telephone networks"
...
Propaganda, from 1928, and one is called Nudge, much more recent in
2008.

So Propaganda.  This is written by Edward Bernays, who is actually
...
So this Torches of Freedom idea was saying see this trend about
...
saying that toasting did it.  It is because they toast the tobacco, it
is less harsh on your throat, and that is what has removed the
prejudice.  So textually they can say: we are not getting into
politics.  We are just saying that toasting is cool, and that is a
lady who smokes.  It is like: I don't see the problem.  But meanwhile,
you have actually hired Edward Bernays to run this campaign.

Oh yeah, I want to read a little bit from his book.  This is his book.
He says:
...
And is like: "That is the old fashioned way."
...
it could go up to 35 or 40.  That would be huge for Mozart Pianos.

So Bernays comes in.  He says: "OK, I could say to people 'Will you
please buy a piano?'.  But I am not going to do that.  I know that
pianos have this kind of elite cache.  And so what I am going to do
...
elite picture, and promote it in our connection to newspapers.
...
And so instead of saying, "Hey will you please buy this piano?" to
people, people are now saying, "Hey, I have this piano shaped hole
that I need to fill?  Do you have something piano-shaped?"
...
or significantly altering their economic incentives.
...
marked.  It is actually helpful.  You can be all like "Oh, I just had
...
of just started by playing around with colors.  So maybe like green is
fun, or maybe this lavender purple thing is the way to go.

So in a new phase of things you start to see: OK, well let's .. can it
be something more white?  Well maybe a little more white.  No?  Well
how about something like a little more white.  Instead of all of these
colors, let us just put it all in one place.  Take all of the
...
mean, who wanted it to be yellow.  It was not that important.  And
then, it is like, you know, the background ...  I mean, people get it.
They get it.
...
So I found this very nice quote from the head of text ads at Google.
He says "we want to make it easier for the user to digest information
on the page, so we are gradually trying to reduce the number of
variations of colors and patterns on the page, and bring a little bit
more harmony to the page."  Like, "we just want harmony".  And that is
why we reduced one of the color elements on the page.  We could have
reduced other color elements.  It is just one color element.  What is
the big deal?
...
fine.  And someone shows up and is like "That work you did last week,
it was terrible.  It is not going to work out.  It was really not
carefully considered."  And that person feels sad.  And the person
yelling at them goes away.
...
Another interaction that is possible is that you might be going about
...
And then you see a friend and say "Hey, did you hear about that?"  And
they are like, "Ah!  That's terrible!"  And they see some of their
friends.  And they are like, "Aw, man!  That thing over there is
really bad!"  Viral!
...
people running Silicon Valley companies in an idealistic way.  They
want to make the world better through tools, they are put into this
choice architecture.  Well, you have these investors, and you don't
want to disappoint them.  Thera are all of these peoples who work at
...
and most combative place.  And then on our programming you will see
more of that, and on the subReddits for individual languages you will
see less.  On places that are just community places, that do not have
accounts that are shared betwee, you will see less.
...
characters available to people.  Another way is to limit the kind of
feedback available.  So instead of saying, "Hey, that was pretty
hurtful", you say "down".  Like a lot of nuance is lost in that sort
of thing.
...
or conferences, or at meetups, or on the street.  All of these places
are _for_ something.  So when a place is for something, you can ask,
"What is inappropriate behavior?"

If I am at work and some discussions keeps going and going, at some
point we have to stop the discussion and make a choice.  We cannot be
in discussion forever.  It is clear because work is for work.
...
speakers who might have something interesting to say to folks, and
then officially in a nice way present that.
...
those sorts of conflicts, and you are talking face to face.  On the
street someone is like standing outsde of Starbucks and being like, "I
had better coffee one time", that is weird.  That is weird behavior.
"And the croissants could be done better.  I don't know how, but they
could.  This isn't it."
...
so the idea is: instead of just having a blank box you write stuff
into, you first choose some intent.  My intent is to learn, let us
say.  And I will get prompted to, say, "what is your background?"
Maybe they just started using Elm, and they have been using Java for a
long time.  And the question is, "Why do I have to explicitly cast
between Int and Float when doing math?"  And then I can submit the
post.

And so when that shows up, this question might have been read in a
...
interpretations of this text.  But when you give some backgroud, it is
like, "OK, I see where this person is coming from.  I can see why they
would be frustrated with that."  And so it is really harder to read it
in a malicious way.
...
then, hey we value citations.  People backing up with evidence, so
maybe they give a citation.  And they can post it.

And so again you get the answer, and so the person asking can say,
"Oh, that is actually not the question I was asking."  So that can
really clarify and help make this process more efficient.  And so
again, instead of reply you can say ask for clarification, or thank
the person.
...
someone wants to learn, we can clarify or answer.  If they choose to
answer, we can choose to clarify the question, or thank you.  Now if
they clarify, maybe you give another answer.  But in the other path,
"Hey, maybe you can give me an example to clarify your question", they
can restate it, and then you can answer.  So the point here is that
...
a really nice time at the park", and someone has a photo of it, and
someone else says, "Hey, that sounds great.  That reminds me of last
week, we were cooking something really nice."

And so you can have these cycles.  But when someone is doing
self-expression, and you are thinking, "Man, that sounds like a really
terrible thing to say", maybe you could have this conversation flow
that says, "Hey, I want to learn about that perspective.  I don't want
to tell you it is wrong, I just want to know why you feel that way."

So maybe what is a little bit interesting here is, the disussion flows
will be different depending on the goals of the community.  If it is
about learning it might be one way.  If it is about self-expression it
might be another way.  And maybe you want safety valves to jump
around.

So another thing that I think is interesting is, say a discussion is
...
this is where you really don't want things to go.

So one thing that might be interesting is that when you see someone
about to reply, you say, "Hey, what would be a successful conclusion
to this interaction?"  Or, "Would it be easier to chat for five
minutes?"  Is there somewhere to take this that is going to be more
constructive.  What do you want to get out of this?
...
feedback is not reaching that person, and they feel increasingly
alienated by these kinds of reactions.  Furthermore, these buttons
kind of uniquely pick out, "Oh, I'm mad", or "Oh, I like that".

So what we might be able to do instead is say, "Hey, for any given
post, here are a couple of things you might notice about it."  Is it
off topic?  Is it helpful?  And if the goal of the place is to help
...
is going to ruin these communities.  So I found this book.  It says:
    ...
    practices, nd a culture which made people as much alike as
...
recognizing that there are these people that understand choice
...
depending upon their life or their experiences.  I think the point
...
So I hope that an interesting way to think about the hard parts of
open source, and I have a bunch of references in case you are
interested in looking back on things.  And I hope people will explore
through programming, like creating communities that we talked about.
...
then it will become another tool for engagement.  That's likely.  We
will see, but thank you very much for your attention and
consideration.
